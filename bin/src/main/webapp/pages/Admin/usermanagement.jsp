        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item menu-open">
            <a href="Welcome?page=usermanagement" class="nav-link active">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <tr>
                    <td><img src="ressources/dist/img/avatar.png" class="img-square elevation-3" style="width:50px;  border-radius:10%;" alt="User Image">   </td>
                    <td>Data</td>
                    <td>Data</td>
                    <td>**********</td>
                    <td>Data</td>
