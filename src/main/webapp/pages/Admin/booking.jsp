...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Brand Logo -->
			<a href="" class="brand-link"> <img src="ressources/dist/img/icon.jpg"
				alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
				style="opacity: .8"> <span
				class="brand-text font-weight-light">Parking Management</span>
			</a>
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						<li class="nav-item"><a href="Welcome?page=dashboard" class="nav-link">
						...
						<li class="nav-item"><a href="#" class="nav-link"> <i
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a href="Welcome?page=owenermanagement"
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									...
									<button class="btn btn-success btn-xs" style="margin-left: 80%"
															...
															<div class="row">
																<div class="col-8">
																	<div class="form-group">
																		<label for="exampleInputEmail1">Reference</label> <input
																...
																<div class="col-4">
																	<div class="form-group">
																		<label for="exampleInputEmail1">Slot</label> <select
																			class="form-control">
																			<option>22</option>
																			<option>23</option>
																		</select>
																...
																<div class="col-6">
																	<div class="form-group">
																		<label for="exampleInputEmail1">Vehicle</label> <select
																			class="form-control">
																			<option>Data</option>
																			<option>Data</option>
																		</select>
																...
																<div class="col-3">
																	<div class="form-group">
																		<label for="exampleInputEmail1">Duration</label> <input
																			type="time" class="form-control" id=""
																			placeholder="0:00">
																	</div>
																</div>
																<div class="col-9">
																...
																<div class="col-12">
																	<div class="form-group">
																		...
																		<textarea row="3" placeholder="Enter.."
