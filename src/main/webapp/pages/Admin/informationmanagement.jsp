        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item menu-open">
                <a href="Welcome?page=informationmanagement" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            <a href="Welcome?page=payment" class="nav-link">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <tr>
                    <td><img src="ressources/dist/img/bg.jpg" class="img-square elevation-3" style="width:50px;  border-radius:10%;" alt="User Image">   </td>
