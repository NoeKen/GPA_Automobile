		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item menu-open"><a href="#"
							...
							<ul class="nav nav-treeview">
								<li class="nav-item menu-open"><a
									href="Welcome?page=owenermanagement" class="nav-link active">
						...
						<li class="nav-item"><a href="Weclome?page=parkingslot"
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									...
									<button class="btn btn-success btn-xs" style="margin-left: 71%"
													...
													<div class="card card-primary">
														<div class="card-body">
															<div class="row">
																...
																<div class="col-6">
																	<div class="form-group">
																		<label for="exampleInputEmail1">Complete
																...
																<div class="col-4">
																	<div class="form-group">
																		<label for="exampleInputEmail1">Civil Status</label> <input
																			type="text" class="form-control" id=""
																...
																<div class="col-5">
																	<div class="form-group">
																		<label for="exampleInputEmail1">Birthdate</label> <input
																	...
																	<div class="form-group">
																		<div class="custom-file">
																			<input type="file" class="custom-file-input"
																				id="customFile"> <label
																				class="custom-file-label" for="customFile">Profile
																				Picture</label>
																		</div>
																	</div>
																</div>
