<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from themesbrand.com/veltrix/layouts/vertical-dark/pages-login.html by HTTrack Website Copier/3.x [XR&CO'2008], Wed, 20 Mar 2019 15:25:42 GMT -->
<head>
<meta charset="utf-8">
...
<link href="ressources/assets/css/bootstrap.min.css" rel="stylesheet"
	type="text/css">
<link href="ressources/assets/css/metismenu.min.css" rel="stylesheet"
	type="text/css">
				...
				method="post"
					...
					<div class="form-group">
						<label for="username">Phone Number</label> <input type="text"
							class="form-control" id="username" name="tel" placeholder="Enter phone number">
					</div>
					<div class="form-group">
					...
					<div class="form-group m-t-10 mb-0 row">
						<div class="col-12 m-t-20">
							<a href="pages-recoverpw.html"><i class="mdi mdi-lock"></i>
		...
		<div class="m-t-40 text-center">
			<p>
				Don't have an account ? <a href="register.jsp"
					class="font-500 text-primary">Signup now</a>
			</p>
		</div>
